...
const CrearClaseForm = ({ options }) => {
    ...
    return (
        <Form layout="vertical"
            ...
            <Form.Item label="Profesor/a" name="profesor" rules={[{ required: true, message: 'Por favor, ingrese el nombre y apellido del Profesor/a.' }]}>
                <Input placeholder="Nombre de Profesor/a" />
            </Form.Item>
            <Checkbox.Group options={daysOptions} defaultValue={['']} onChange={onChange} />

            <Form.Item label="Hora de Inicio" rules={[{ required: true, message: 'Por favor, seleccione un horario de inicio.' }]}>
                <Select
                    showSearch
